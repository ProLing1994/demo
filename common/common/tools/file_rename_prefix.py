...
if __name__ == '__main__':
    input_dir = "/mnt/huanyuan/data/speech/kws/xiaoan_dataset/experimental_dataset/XiaoAnDataset/xiaoanxiaoan_16k/"
    old_file_format = 'RM_KWS_XIAORUI_xiaorui_'
    new_file_format = 'RM_KWS_XIAOAN_xiaoan_'
    file_type = ".wav"
