...
find_library(KALDI_ONLINE_LIBRARY kaldi-online.a
  HINTS ${KALDI_DIR} 
  PATH_SUFFIXES src/online)
...
find_package_handle_standard_args(
  KALDI DEFAULT_MSG KALDI_INCLUDE_DIR KALDI_ONLINE_LIBRARY KALDI_ONLINE2_LIBRARY KALDI_IVECTOR_LIBRARY KALDI_NNET3_LIBRARY KALDI_CHAIN_LIBRARY 
...
if(KALDI_FOUND)
  ...
  set(KALDI_LIBRARIES ${KALDI_ONLINE_LIBRARY} ${KALDI_ONLINE2_LIBRARY} ${KALDI_IVECTOR_LIBRARY} ${KALDI_NNET3_LIBRARY} ${KALDI_CHAIN_LIBRARY} 
  ${KALDI_CUDAMATRIX_LIBRARY} ${KALDI_DECODER_LIBRARY} ${KALDI_LAT_LIBRARY} ${KALDI_FSTEXT_LIBRARY} ${KALDI_HMM_LIBRARY}
  ${KALDI_FEAT_LIBRARY} ${KALDI_TRANSFORM_LIBRARY} ${KALDI_GMM_LIBRARY} ${KALDI_TREE_LIBRARY} ${KALDI_UTIL_LIBRARY}
  ${KALDI_MATRIX_LIBRARY} ${KALDI_BASE_LIBRARY})
