...
extern unsigned long long appended_wave_resize_time;
...
int main(int argc, char *argv[]) {
  try {
    ...
    unsigned long long total_appended_wave_resize_time = 0;
    uint32 loop_time = 0;
    ...
    for (; !spk2utt_reader.Done(); spk2utt_reader.Next()) {
      ...
      for (size_t i = 0; i < uttlist.size(); i++) {
        ...
        while (samp_offset < data.Dim()) {
          ...
          std::cout <<"\033[0;31mAppended wave resize time " << appended_wave_resize_time << " ms. \033[0;39m" << std::endl;
          std::cout <<"\033[0;31mAccept feature per frame time " << get_frame_feature_time - get_frame_wave_data_after_time << " ms. \033[0;39m" << std::endl;
          total_appended_wave_resize_time += appended_wave_resize_time;
          appended_wave_resize_time = 0;
        ...
        std::cout <<"\033[0;31mTotal appended wave resize time " << total_appended_wave_resize_time << " ms. \033[0;39m" << std::endl;
