...
if __name__ == "__main__":
    ...
    # safezone：[('car', 228261)]
    # finished：[('CAR', 14), ('car', 797921), ('car ', 1037), ('person', 8107)]
    ...
    # 数据集: jiayouzhan，[('bus', 685), ('car', 12295), ('fuzzy_plate', 1792), ('plate', 9800), ('roi_ignore_plate', 227), ('truck', 180)]
    # 数据集: jiayouzhan_5M，[('bus', 488), ('car', 7776), ('fuzzy_plate', 1158), ('painted_plate', 175), ('plate', 4014), ('truck', 22)]
    # 数据集: sandaofangxian，[('bus', 1784), ('car', 9226), ('fuzzy_plate', 4421), ('painted_plate', 449), ('plate', 5534), ('truck', 13267)]
    # 数据集: shenzhentiaoqiao，[('bus', 5450), ('car', 29446), ('fuzzy_plate', 16626), ('plate', 7620), ('truck', 781)
