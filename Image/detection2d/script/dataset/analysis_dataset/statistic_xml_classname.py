...
if __name__ == "__main__":
    ...
    # args.input_dir = "/yuanhuan/data/image/RM_ANPR/original/Brazil/Brazil/brazil_02210_202301/"
    ...
    # 数据集: brazil_02210_202301, [('bicyclist', 38), ('bus', 15165), ('car', 433038), ('cover-motorplate', 2905), ('cover-plaet', 37229), ('fuzzy-motorplate', 22150), ('fuzzy-plate', 84662), ('kind', 1), ('lince-motorplate', 19846), ('lince-plate', 113262), ('motorcycle', 27374), ('motorcyclist', 31297), ('num', 3), ('truck', 34930)]
