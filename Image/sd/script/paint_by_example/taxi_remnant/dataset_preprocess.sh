...
# crop_data_dir=/yuanhuan/data/image/Taxi_remnant/training/sd_crop_clip_sam_bottle_all_0825/shenzhen
# clip_ref_class=bottle
# crop_data_dir=/yuanhuan/data/image/Taxi_remnant/training/sd_crop_clip_sam_wallet_all_0825/shenzhen
# clip_ref_class=wallet
# crop_data_dir=/yuanhuan/data/image/Taxi_remnant/training/sd_crop_clip_sam_umbrella_all_0825/shenzhen
# clip_ref_class=umbrella
