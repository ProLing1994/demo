...
if __name__ == "__main__":
    ...
    args.output_img_train_dir = os.path.join(args.output_dir, "data", "images", "train_0")
    args.output_img_val_dir = os.path.join(args.output_dir, "data", "images", "validation")
    args.output_img_test_dir = os.path.join(args.output_dir, "data", "images", "test")

    args.output_bbox_train_dir = os.path.join(args.output_dir, "data", "bbox", "train_0")
    args.output_bbox_val_dir = os.path.join(args.output_dir, "data", "bbox", "validation")
    args.output_bbox_test_dir = os.path.join(args.output_dir, "data", "bbox", "test")
