...
def inference_images(args):
    ...
    for idx in tqdm(range(len(img_list))):
        ...
        # bboxes filter
        bboxes["license_plate"] = plate_bboxes_filter(bboxes["license_plate"], mode='ltrb')
        ...
        if args.write_xml_bool:
            ...
            xml_adder.add_object("license_plate", bboxes["license_plate"])
...
def main():
    ...
    args.plate_model_path = "/yuanhuan/model/image/license_plate_model_wjh/国内、新加坡/MobileNetSmallV1_PO_singapore_Wdm_2020_03_19_17_36_30_PT_best/MobileNetSmallV1_PO_singapore_Wdm_2020_03_19_17_36_30_PT_best.pt"
    args.plate_config_path = "/yuanhuan/code/demo/Image/regreesion2d/plate_regreesion/config/config.py"
    args.img_dir = "/yuanhuan/data/image/RM_ADAS_AllInOne/allinone/JPEGImages"
    args.xml_dir = "/yuanhuan/data/image/RM_ADAS_AllInOne/allinone/XML"
    args.output_img_dir = "/yuanhuan/data/image/RM_ADAS_AllInOne/allinone/test"
    args.output_xml_dir = "/yuanhuan/data/image/RM_ADAS_AllInOne/allinone/XML_license_plate"
    args.write_img_bool = False
    args.write_xml_bool = True
