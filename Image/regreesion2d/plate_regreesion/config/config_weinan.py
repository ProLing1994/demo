...
class Config(object):
    def __init__(self):
        self.folder_name = "MobileNetSmallV1_WeiNan_Wdm_PT_sgd"
        self.save_path_prefix = "/jhwen/train/out/plate_regression/weinan"
        self.img_mean = 127.5
        ...
        self.train_set_mat_file = "/jhwen/train/data/plate_after_crop/weinan_regression/train_crop.pkl"
        self.validation_set_mat_file = "/jhwen/train/data/plate_after_crop/weinan_regression/val_crop.pkl"
        self.log_flag = True
        self.print_freq = 5
        self.epochs = 20
...
# /jhwen/train/code/plate_regression/train.sh -c config/config_weinan.py
