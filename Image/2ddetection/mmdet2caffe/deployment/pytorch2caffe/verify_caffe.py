...
def load_data(input_img_size):
    # size = (1, 3) + input_img_size
    # data = np.random.rand(*size)
    image = cv2.imread('/phzhang/mmdetection-master-zhiguan/tools/deployment/pytorch2caffe/test.jpg')
...
def compare():
    ...
    pytorch_data = pytorch_blobs[0][0][0].data.numpy().flatten()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--caffe_blob_name", type=str, default="cat_blob2")
