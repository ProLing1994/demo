...
from Image.Demo.license_plate_capture_china_gantry_scene.demo.RMAI_API import *
from Image.regreesion2d.plate_regreesion.utils.draw_tools import draw_bbox_tracker, draw_bbox_info, draw_bbox_state, draw_capture_line
...
def main():
    ...
    # args.video_dir = "/mnt/huanyuan2/data/image/ZG_ZHJYZ_detection/jiayouzhan_test_video/ZG_AHHBGS/264原始视频/5M_12mm_卡口2_白_0520/"
    # args.video_dir = "/mnt/huanyuan2/data/image/ZG_ZHJYZ_detection/jiayouzhan_test_video/ZG_AHHBGS/264原始视频/5M_12mm_卡口3_白_0520/"
    # args.video_dir = "/mnt/huanyuan2/data/image/ZG_ZHJYZ_detection/jiayouzhan_test_video/ZG_AHHBGS/264原始视频/5M_12mm_卡口3_夜_0620/"
    # args.output_video_dir = "/home/huanyuan/temp/pc_车牌抓拍实验_版本0730/5M_12mm_卡口2_夜_0620_叠加及抓拍结果/"
    # args.output_video_dir = "/mnt/huanyuan/temp/pc_车牌抓拍实验_版本0730/5M_12mm_卡口2_夜_0620_叠加及抓拍结果/"
    # args.suffix = '.avi'
