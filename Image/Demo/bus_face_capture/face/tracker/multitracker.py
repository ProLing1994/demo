...
class JDETracker(object):
    ...
    def update(self, dets, id_feature):
        ...
        #for strack in strack_pool:
            #strack.predict()
        STrack.multi_predict(strack_pool)  ## kalman predict result
        ...
        for itracked, idet in matches:
            ...
            track.dists = dists[itracked,idet]
            det = detections[idet]
            det.dists = dists[itracked,idet]
        ...
        for itracked, idet in matches:
            ...
            unconfirmed[itracked].dists = dists[itracked,idet]
        ...
        for t in output_stracks:
            tlwh = t.tlwh         #left local and w h
            tid = t.track_id
            tscore = t.score

            if tlwh[2] * tlwh[3] > self.min_box_area_thres:
                tracker_bboxes.append( [tlwh[0], tlwh[1], tlwh[0] + tlwh[2], tlwh[1] + tlwh[3], tscore, int(tid)] )
