...
def inference_video(args):
    ...
    for idx in tqdm(range(len(video_list))):
        ...
        while True:
            ...
            # capture_dict
            # capture_result：抓拍结果
            bbox_info_list, capture_line, capture_dict, capture_result = capture_api.run(img, frame_idx)
            ...
            if args.write_result_per_frame_bool:
                # draw bbox
                img = draw_bbox_info(img, bbox_info_list, capture_dict, mode='ltrb')
...
def main():
    ...
    args.video_dir = "/mnt/huanyuan2/data/image/ZG_ZHJYZ_detection/jiayouzhan_test_video/ZG_AHHBGS/264原始视频/5M_12mm_卡口2_夜_0620/"
