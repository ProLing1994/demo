...
from Image.Demo.license_plate_capture_china_parking_scene.demo.RMAI_API import *
from Image.Demo.license_plate_capture_china_parking_scene.utils.draw_tools import draw_bbox_tracker, draw_bbox_info, draw_bbox_state, draw_capture_line
...
def inference_video(args):
    ...
    for idx in tqdm(range(len(video_list))):
        ...
        while True:
            ...
            # capture api
            tracker_bboxes, bbox_info_list, bbox_state_map, capture_line_up_down, capture_line_left_right, capture_dict, capture_result = capture_api.run(img, frame_idx)
...
def main():
    ...
    # args.video_dir = "/mnt/huanyuan2/data/image/ZG_GDZP/test_video/avi视频/test/640_368/"
    args.output_video_dir = "/mnt/huanyuan/temp/pc_demo/ZG_GDZP/test_video/1280_720/"
