...
if __name__ == "__main__":
    ...
    args.video_dir = "/mnt/huanyuan2/data/image/Brazil_anpr/test_video/BM_Brazil/avi文件/test/"
    args.output_video_dir = "/mnt/huanyuan2/data/image/Brazil_anpr/test_video/BM_Brazil/avi文件/test_jpg/"
    # args.suffix = '.mp4'
    args.suffix = '.avi'
    # args.frame_strp = 25
    args.frame_strp = 10
