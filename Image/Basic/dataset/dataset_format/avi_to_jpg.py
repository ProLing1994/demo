...
if __name__ == "__main__":
    ...
    args.video_dir = "/mnt/huanyuan2/data/image/HY_Tanker/test_video/误报漏报/算法误报_20230206/avi/"
    args.output_video_dir = "/mnt/huanyuan2/data/image/HY_Tanker/test_video/误报漏报/算法误报_20230206/jpg/"
    args.suffix = '.mp4'
    # args.suffix = '.avi'
    args.frame_strp = 25
    # args.frame_strp = 10
