...
def main():
    ...
    args.video_dir = "/mnt/huanyuan/temp/卡口3/2022-03-29/avi/"
    args.output_video_dir = "/mnt/huanyuan/temp/卡口3/2022-03-29/avi_video_capture/"
    args.suffix = '.avi'
    ...
    out = p.map(vidio_capture_crop, in_params)
    p.close()
    p.join()
