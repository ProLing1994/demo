...
if __name__ == "__main__":
    ...
    args.vidio_dir = "/mnt/huanyuan2/data/image/ZG_ZHJYZ_detection/智观数据_模拟数据剩余"
    args.output_vidio_dir = "/mnt/huanyuan2/data/image/ZG_ZHJYZ_detection/智观数据_模拟数据剩余/avi_to_jpg/"
    args.suffix = '.avi'
    args.frame_strp = 10
