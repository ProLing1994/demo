...
if __name__ == "__main__":
    ...
    # SZTQ: [('bus', 218), ('car', 1419), ('fuzzy_plate', 431), ('planted_plate', 63), ('plate', 461), ('truck', 18)]

    # 数据集：ZG_BMX_detection 智观斑马线数据集
    # args.input_dir = "/yuanhuan/data/image/ZG_BMX_detection/shenzhenlukou_yejian/"
    # daminghu: [('bicycle', 7848), ('car', 25982), ('motorcycle', 3862), ('non-motorized', 13439), ('person', 98428)]
    # daminghu: [('bicycle', {'trainval': 7048, 'test': 800}), ('car', {'trainval': 23453, 'test': 2529}), ('motorcycle', {'trainval': 3472, 'test': 390}), ('non-motorized', {'trainval': 11977, 'test': 1462}), ('person', {'trainval': 88765, 'test': 9663})]
    # yongzou_night_hongwai: [('bicycle', 378), ('car', 3096), ('face', 1), ('motorcycle', 16870), ('non-motorized', 908), ('person', 36271)]
    # yongzou_night_hongwai: [('bicycle', {'trainval': 343, 'test': 35}), ('car', {'trainval': 2770, 'test': 326}), ('face', {'trainval': 1, 'test': 0}), ('motorcycle', {'trainval': 15197, 'test': 1673}), ('non-motorized', {'trainval': 832, 'test': 76}), ('person', {'trainval': 32594, 'test': 3677})]
    # anquandao：[('bicycle', 1057), ('car', 20662), ('head', 7890), ('helmet', 677), ('non-motorized', 1234), ('non-motorized ', 2), ('person', 7621)]
    # anquandao：[('bicycle', {'trainval': 932, 'test': 125}), ('car', {'trainval': 18631, 'test': 2031}), ('head', {'trainval': 7081, 'test': 809}), ('helmet', {'trainval': 594, 'test': 83}), ('non-motorized', {'trainval': 1102, 'test': 132}), ('non-motorized ', {'trainval': 2, 'test': 0}), ('person', {'trainval': 6823, 'test': 798})]
    # anquandao_night_hongwai：[('bicycle', 777), ('car', 15199), ('face', 1), ('head', 5276), ('helmet', 406), ('motorcycle', 14), ('non-motorized', 1279), ('person', 5657)]
    # anquandao_night_hongwai：[('bicycle', {'trainval': 696, 'test': 81}), ('car', {'trainval': 13716, 'test': 1483}), ('face', {'trainval': 1, 'test': 0}), ('head', {'trainval': 4722, 'test': 554}), ('helmet', {'trainval': 355, 'test': 51}), ('motorcycle', {'trainval': 14, 'test': 0}), ('non-motorized', {'trainval': 1139, 'test': 140}), ('person', {'trainval': 5055, 'test': 602})]
    # shandongyingzikou：[('car', 10815), ('motorcycle', 681), ('non-motorized', 356), ('person', 855)]
    # shandongyingzikou：[('car', {'trainval': 9705, 'test': 1110}), ('motorcycle', {'trainval': 618, 'test': 63}), ('non-motorized', {'trainval': 315, 'test': 41}), ('person', {'trainval': 770, 'test': 85})]
    # shandongyingzikou_night_diguangzhao: [('car', 2706), ('motorcycle', 201), ('non-motorized', 76), ('person', 21)]
    # shandongyingzikou_night_diguangzhao: [('car', {'trainval': 2442, 'test': 264}), ('motorcycle', {'trainval': 174, 'test': 27}), ('non-motorized', {'trainval': 65, 'test': 11}), ('person', {'trainval': 20, 'test': 1})]
    # shenzhenlukou_yejian: [('bicycle', 915), ('car', 41475), ('motorcycle', 871), ('non-motorized', 1064), ('person', 12416)]
    # shenzhenlukou_yejian: [('bicycle', {'trainval': 805, 'test': 110}), ('car', {'trainval': 37336, 'test': 4139}), ('motorcycle', {'trainval': 787, 'test': 84}), ('non-motorized', {'trainval': 946, 'test': 118}), ('person', {'trainval': 11148, 'test': 1268})]
