...
#     # normal
#     python /yuanhuan/code/demo/Image/recognition2d/script/lpr/dataset/dataset_brazil/dataset_check/dataset_csv.py --date_name=$date_name --input_dir=$data_dir --output_csv_dir=$data_csv_dir --output_crop_data_dir=$data_crop_dir --output_error_data_dir=$error_data_dir --bool_write_error_data
