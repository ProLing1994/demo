...
if __name__ == "__main__":
    ...
    args.output_img_dir = os.path.join(args.output_dir, 'city_label/Images_aug')
    args.output_mask_dir = os.path.join(args.output_dir, 'city_label/mask_aug')
    args.output_mask_img_dir = os.path.join(args.output_dir, 'city_label/mask_img_aug')
    args.output_bbox_img_dir = os.path.join(args.output_dir, 'city_label/bbox_img_aug')
    args.input_csv_path = os.path.join(args.output_dir, 'city_label', args.date_name + '.csv')
    args.output_csv_path = os.path.join(args.output_dir, 'city_label', args.date_name + '_augument.csv')
    ...
    args.data_dict_name = "dataset_zd_dict_color" 
