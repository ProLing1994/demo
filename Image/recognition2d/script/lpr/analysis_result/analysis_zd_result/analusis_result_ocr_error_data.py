...
if __name__ == "__main__":
    ...
    args.input_dir = "/yuanhuan/model/image/lpr/paddle_ocr/v1_brazil_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230822_only_diffste"
    # args.input_dir = "/yuanhuan/model/image/lpr/paddle_ocr/v1_brazil_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230822_wdiffste_NoAug"
    # args.input_dir = "/yuanhuan/model/image/lpr/paddle_ocr/v1_brazil_mobilenet_v1_rm_cnn_tc_res_mobile_rmresize_gray_64_256_20230822_wdiffste"
    ...
    args.input_error_data_csv = os.path.join(args.input_dir, "inference", "test_caffe", "data_brazil_trainval_result.csv")
    args.output_error_data_dir = os.path.join(args.input_dir, "inference", "error_data", "data_brazil_trainval_result")
    # args.input_error_data_csv = os.path.join(args.input_dir, "inference", "test_caffe", "data_brazil_original_result.csv")
    # args.output_error_data_dir = os.path.join(args.input_dir, "inference", "error_data", "data_brazil_original_result")
