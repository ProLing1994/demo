...
for date_name in ${date_name_list[@]}; do 
    ...
    python /yuanhuan/code/demo/Image/segmentation2d/script/dataset/dataset_safeisland/dataset_r151/dataset_move/data_move.py --date_name=$date_name --input_dir=$data_dir --seg_name=$seg_name --output_dir=$training_data_dir
