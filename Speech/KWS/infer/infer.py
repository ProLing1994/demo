...
def double_edge_detecting(scores, word_num=2):
    ...
    if result_mode == 'double_edge_triggered_detecting':
        ...
        if len(score_list) > average_window_length:
            ...
            for windows_idx in range(windows_number):
                ...
                score = double_edge_detecting(score_list_window)
...
def main():
    ...
    default_average_window_duration_ms = 800        # only for mode: average_duration_ms/double_edge_triggered_detecting
    ...
    parser.add_argument('--input', type=str, default="/home/huanyuan/code/demo/Speech/KWS/config/kws/kws_confid_align_xiaoyu.py", help='config file')
