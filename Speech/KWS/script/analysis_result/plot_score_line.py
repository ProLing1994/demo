...
def show_score_line(src_csv, pst_csv, positive_label_list, positive_label_idx="2"):
    """
    绘制得分曲线
    ...
    for idx in tqdm(range(len(src_list))):
        ...
        for x_idx in range(plot_x.shape[0]):
            if plot_x[x_idx] > src_list[idx]['start_time'] and plot_x[x_idx] < src_list[idx]['end_time'] and src_list[idx]['label'] in positive_label_list:
                plot_y_src_positive[x_idx] = 1

            if plot_x[x_idx] > src_list[idx]['start_time'] and plot_x[x_idx] < src_list[idx]['end_time'] and src_list[idx]['label'] not in positive_label_list:
...
if __name__ == "__main__":
    ...
    # # xiaorui
    # model_name = "kws_xiaorui8k_56_196_1_0_resnet14_fbankcpu_06252021"
    # threshold = "0.5"
    # positive_label_idx = "1"
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaorui_1_4_04302021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_xiaorui/{}/test_straming_wav/xiaorui_1_4_04302021_training_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaorui"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaorui_1_4_04302021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_xiaorui/{}/test_straming_wav/xiaorui_1_4_04302021_training_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaorui"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaorui_1_4_04302021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_xiaorui/{}/test_straming_wav/xiaorui_1_4_04302021_validation_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaorui"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaorui_1_4_04302021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_xiaorui/{}/test_straming_wav/xiaorui_1_4_04302021_validation_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaorui"], positive_label_idx=positive_label_idx)
    ...
    # # xiaoan8k
    # model_name = "kws_xiaoan8k_3_1_tc-resnet14-hisi_fbankcpu_kd_05152021"
    # threshold = "0.8"
    # positive_label_idx = "1"
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan8k_1_1_04082021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan8k_1_1_04082021_training_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_8k", "xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan8k_1_1_04082021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan8k_1_1_04082021_training_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_8k", "xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan8k_1_1_04082021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan8k_1_1_04082021_validation_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_8k", "xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan8k_1_1_04082021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan8k_1_1_04082021_validation_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_8k", "xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    ...
    # threshold = "0.8"
    # positive_label_idx = "1"
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan16k_2_1_04082021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan16k_2_1_04082021_training_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan16k_2_1_04082021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan16k_2_1_04082021_training_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan16k_2_1_04082021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan16k_2_1_04082021_validation_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/xiaoan16k_2_1_04082021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/xiaoan16k_2_1_04082021_validation_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["xiaoanxiaoan_16k"], positive_label_idx=positive_label_idx)

    # # nihaoxiaoan8k
    # model_name = "kws_nihaoxiaoan8k_1_0_res15_fbankcpu_04102021"
    # threshold = "0.8"
    # positive_label_idx = "1"
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan8k_3_0_04102021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan8k_3_0_04102021_training_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_8k", "nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan8k_3_0_04102021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan8k_3_0_04102021_training_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_8k", "nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan8k_3_0_04102021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan8k_3_0_04102021_validation_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_8k", "nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan8k_3_0_04102021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan8k_3_0_04102021_validation_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_8k", "nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)

    # nihaoxiaoan16k     
    # model_name = "kws_nihaoxiaoan16k_1_0_res15_fbankcpu_04102021"
    # threshold = "0.8"
    # positive_label_idx = "1"
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan16k_4_0_04102021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan16k_4_0_04102021_training_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan16k_4_0_04102021_training_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan16k_4_0_04102021_training_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan16k_4_0_04102021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan16k_4_0_04102021_validation_60_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/nihaoxiaoan16k_4_0_04102021_validation_60.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/nihaoxiaoan16k_4_0_04102021_validation_60_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["nihaoxiaoan_16k"], positive_label_idx=positive_label_idx)
    ...
    show_score_line("/mnt/huanyuan/model/test_straming_wav/activatebwc_03232021_training_60_001.csv",
                    "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_english/{}/test_straming_wav/activatebwc_03232021_training_60_001_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
                    ["activatebwc"], positive_label_idx=positive_label_idx)
    show_score_line("/mnt/huanyuan/model/test_straming_wav/activatebwc_03232021_training_60_001.csv",
                    "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_english/{}/test_straming_wav/activatebwc_03232021_training_60_001_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
                    ["activatebwc"], positive_label_idx=positive_label_idx)
    show_score_line("/mnt/huanyuan/model/test_straming_wav/activatebwc_03232021_validation_60_001.csv",
                    "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_english/{}/test_straming_wav/activatebwc_03232021_validation_60_001_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
                    ["activatebwc"], positive_label_idx=positive_label_idx)
    show_score_line("/mnt/huanyuan/model/test_straming_wav/activatebwc_03232021_validation_60_001.csv",
                    "/mnt/huanyuan/model/model_10_30_25_21/model/kws/kws_english/{}/test_straming_wav/activatebwc_03232021_validation_60_001_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
                    ["activatebwc"], positive_label_idx=positive_label_idx)

    # # heybodycam
    # model_name = "kws_heybodycam_1_3_res15_fbankcpu_15_03222021"
    # threshold = "0.8"
    # positive_label_idx = "1"
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/heybodycam_03232021_training_60_001.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/heybodycam_03232021_training_60_001_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["heybodycam"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/heybodycam_03232021_training_60_001.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/heybodycam_03232021_training_60_001_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["heybodycam"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/heybodycam_03232021_validation_60_001.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/heybodycam_03232021_validation_60_001_threshold_{}/final_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["heybodycam"], positive_label_idx=positive_label_idx)
    # show_score_line("/mnt/huanyuan/model/test_straming_wav/heybodycam_03232021_validation_60_001.csv",
    #                 "/mnt/huanyuan/model/model_10_30_25_21/model/{}/test_straming_wav/heybodycam_03232021_validation_60_001_threshold_{}/original_scores.csv".format(model_name, "_".join(threshold.split('.'))),
    #                 ["heybodycam"], positive_label_idx=positive_label_idx)
