...
# init
# xiaorui
config_file=/mnt/huanyuan/model/model_10_30_25_21/model/kws_xiaorui1_3_res15_12162020/kws_config_xiaorui.py
...
if [ $stage -le 2 ];then
    python ../../infer/test_streaming_wav.py --mode "1" --csv_path $csv_path --type "normal_driving" --bool_noise_reduction True --config_file $config_file || exit 1
    python ./static_result.py --config_file $config_file --csv_path $csv_path --type "normal_driving" --bool_noise_reduction True || exit 1
fi
...
if [ $stage -le 4 ];then
    python ../../infer/test_streaming_wav.py --mode "1" --csv_path $csv_path --type "idling_driving" --bool_noise_reduction True --config_file $config_file || exit 1
    python ./static_result.py --config_file $config_file --csv_path $csv_path --type "idling_driving" --bool_noise_reduction True || exit 1
fi
