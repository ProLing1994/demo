...
class OnlineAudio:
    ...
    def wake_up(self, event, queue):
        ...
        # config_file = "/mnt/huanyuan/model/model_10_30_25_21/model/kws_pretrain_align_word_1_9_12102020/kws_config_align_pretrain.py"     # 2/0.7/_/30/1500, xiaorui\xiaoya\xiaodu\xiaoyu
