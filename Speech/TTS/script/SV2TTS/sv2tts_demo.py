...
def interactive_speech_generation(args):
    ## Load the models one by one.
    print("Preparing the encoder, the synthesizer and the vocoder...")
    encoder.load_model(args.enc_model_fpath)
    synthesizer = Synthesizer(args.syn_model_fpath)
...
if __name__ == '__main__':
    """
    多说话人语音合成系统 Multispeaker Text-To-Speech Synthesis demo
    https://github.com/ProLing1994/Real-Time-Voice-Cloning
    """
    ## Info & args
    ...
    if not args.no_mp3_support:
        try:
            librosa.load(SV2TTS_path + "samples/1320_00000.mp3")
    ...
    ## Interactive speech generation
    interactive_speech_generation(args)