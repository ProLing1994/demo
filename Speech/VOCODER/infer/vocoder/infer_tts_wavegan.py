...
def main():
    ...
    # chinese
    # parser.add_argument('-t', '--tts_config_file', type=str, default="/mnt/huanyuan/model/tts/chinese_tts/sv2tts_chinese_new_tacotron2_singlespeaker_prosody_py_1_0_11102021/tts_config_chinese_sv2tts.py", nargs='?', help='config file')           # tacotron2 单说话人，韵律标签（和 vocoder 组合效果不好）
    parser.add_argument('-t', '--tts_config_file', type=str, default="/mnt/huanyuan/model/tts/chinese_tts/sv2tts_chinese_new_tacotron2_singlespeaker_prosody_py_1_3_diff_feature_11292021/tts_config_chinese_sv2tts.py", nargs='?', help='config file')  # tacotron2 单说话人，韵律标签，与 vocoder 采用相同的特征，stop 预测位置优化，静音处优化（效果好）
