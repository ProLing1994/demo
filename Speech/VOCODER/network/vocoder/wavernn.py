...
class WaveRNN(nn.Module):
    def __init__(self, cfg):
        ...
        self.upsample = UpsampleNetwork(self.feat_dims, self.upsample_factors, self.compute_dims, self.res_blocks, self.res_out_dims, self.pad)
        ...
        self.fc1 = nn.Linear(self.rnn_dims + self.aux_dims, self.rnn_dims)
    ...
    def num_params(self, print_out=True):
        ...
        if print_out :
            print('Wavernn Parameters: %.3fM' % parameters)
