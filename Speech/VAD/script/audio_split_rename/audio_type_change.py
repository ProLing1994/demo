...
def main():
    default_input_dir = "/mnt/huanyuan/data/speech/Recording_sample/Radio_sample/QingTingFM/news/全国新闻联播/"
    default_output_dir = "/mnt/huanyuan/data/speech/Recording_sample/Radio_sample/QingTingFM/news/全国新闻联播_wav/"
    parser = argparse.ArgumentParser(description="")
    parser.add_argument('--input_dir', type=str, default=default_input_dir)
    parser.add_argument('--output_dir', type=str, default=default_output_dir)
    parser.add_argument('--input_type', type=str, default='.m4a')
