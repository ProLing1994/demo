...
if __name__ == '__main__':
    ...
    # parser.add_argument('-m', '--mode', type=str, default="training,testing,evaluate")
    ...
    parser_create_indexes.add_argument('-m', '--mode', type=str, default="training,testing,evaluate")
